...
const planetCollaboratorSchema = new mongoose.Schema({
    ...
    role: {
        ...
        validate: {
            ...
            message: props => `${props.value} is not a valid role. Allowed roles are: owner, collaborator.`
        }
    },
    createdAt: {
        type: Date,
...
module.exports = mongoose.model("planet_collaborators", planetCollaboratorSchema); //Entries are added to 'planet_collaborators' collection