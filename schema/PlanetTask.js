...
if ("planet_tasks" in mongoose.connection.models) {
    module.exports = mongoose.model("planet_tasks");
} else {
    module.exports = mongoose.model("planet_tasks", planetTaskSchema); //Entries are added to 'planet_tasks' collection
}
